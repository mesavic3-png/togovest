...
export default async function AdminPage() {
  ...
  const [users, pendingProperties, agencies, unverifiedAgencies, bookings, payments, ads, adRequests] = await Promise.all([
    prisma.user.count(),
