...
export default async function AdminPage() {
  ...
  const [users, pendingProperties, agencies, unverifiedAgencies, bookings, payments, reports] = await Promise.all([
    prisma.user.count(),
  ...
  const cards = [
    ...
    { label: "Signalements", value: reports, href: "/admin/signalements", note: "Annonces signalées" },
