        ...
        <div className="relative grid gap-10 lg:grid-cols-[1.15fr_.85fr] lg:items-center">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link href="/agence" className="inline-flex items-center justify-center gap-2 rounded-full border border-white/25 px-6 py-3.5 text-center font-bold transition hover:border-lime/50 hover:bg-white/5">
